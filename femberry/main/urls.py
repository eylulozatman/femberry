...
urlpatterns = [
    ...
    path('create-new-poll/',views.create_new_poll_view,name = 'create-new-poll'),
    path('answer-poll/', views.answer_poll_view, name='answer-poll'),
    path('polls/results/<int:poll_id>/', views.results_view, name='poll-results'),  # Bu satırı ekleyin
